...
public class LabModelController : ControllerBase
{
    ...
    private readonly PathLabDataService dataService;
    public LabModelController(ILogger<LabModelController> logger, PathLabDataService dataService)
    {
        this.logger = logger;
