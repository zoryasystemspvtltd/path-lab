    ...
    public partial class Home : Form
    {
        ...
        private void TCP_SendData()
        {
            try
            {
                ...
                //string msg = $"MSH|{specialchar}|LabXpert|Mindray|||20230505175809||ORU^R01|8904|P|2.3.1||||||UNICODE{Constants.vbCr}PID|1||^^^^MR{Constants.vbCr}PV1|1{Constants.vbCr}OBR|1||1770111e|00001^Automated Count^99MRC|||20230505175553|||||||||||||||||HM|NotValidated|||||||Administrator{Constants.vbCr}OBX|1|IS|08001^Take Mode^99MRC||A||||||F{Constants.vbCr}OBX|2|IS|08002^Blood Mode^99MRC||W||||||F{Constants.vbCr}OBX|3|IS|08003^Test Mode^99MRC||CBC+DIFF||||||F{Constants.vbCr}OBX|4|IS|01002^Ref Group^99MRC||General||||||F{Constants.vbCr}OBX|5|IS|01006^Recheck flag^99MRC||T||||||F{Constants.vbCr}OBX|6|IS|05007^Project Type^99MRC||BL||||||F{Constants.vbCr}OBX|7|ST|01012^Shelf No^99MRC||1||||||F{Constants.vbCr}OBX|8|ST|01013^Tube No^99MRC||1||||||F{Constants.vbCr}OBX|9|ST|09001^Analyzer^99MRC||BC-6200_1||||||F{Constants.vbCr}OBX|10|ST|09003^SN^99MRC||TW-02000906||||||F{Constants.vbCr}OBX|11|ST|09999^AuditResult^99MRC||Re-exam||||||F{Constants.vbCr}OBX|12|NM|6690-2^WBC^LN||7.79|10*3/uL|4.00-10.00|N|||F{Constants.vbCr}OBX|13|NM|751-8^NEU#^LN||5.53|10*3/uL|2.00-7.00|N|||F{Constants.vbCr}OBX|14|NM|731-0^LYM#^LN||1.10|10*3/uL|0.80-4.00|N|||F{Constants.vbCr}OBX|15|NM|742-7^MON#^LN||0.55|10*3/uL|0.12-1.20|N|||F{Constants.vbCr}OBX|16|NM|711-2^EOS#^LN||0.54|10*3/uL|0.02-0.50|H~N|||F{Constants.vbCr}OBX|17|NM|704-7^BAS#^LN||0.07|10*3/uL|0.00-0.10|N|||F{Constants.vbCr}OBX|18|NM|51584-1^IMG#^LN||0.02|10*3/uL|0.00-999.99|N|||F{Constants.vbCr}OBX|19|NM|770-8^NEU%^LN||70.9|%|50.0-70.0|H~N|||F{Constants.vbCr}OBX|20|NM|736-9^LYM%^LN||14.2|%|20.0-40.0|L~N|||F{Constants.vbCr}OBX|21|NM|5905-5^MON%^LN||7.1|%|3.0-12.0|N|||F{Constants.vbCr}OBX|22|NM|713-8^EOS%^LN||6.9|%|0.5-5.0|H~N|||F{Constants.vbCr}OBX|23|NM|706-2^BAS%^LN||0.9|%|0.0-1.0|N|||F{Constants.vbCr}OBX|24|NM|38518-7^IMG%^LN||0.3|%|0.0-100.0|N|||F{Constants.vbCr}OBX|25|NM|789-8^RBC^LN||2.99|10*6/uL|3.50-5.50|L~N|||F{Constants.vbCr}OBX|26|NM|718-7^HGB^LN||8.5|g/dL|11.0-16.0|L~N|||F{Constants.vbCr}OBX|27|NM|4544-3^HCT^LN||25.6|%|37.0-54.0|L~N|||F{Constants.vbCr}OBX|28|NM|787-2^MCV^LN||85.6|fL|80.0-100.0|N|||F{Constants.vbCr}OBX|29|NM|785-6^MCH^LN||28.4|pg|27.0-34.0|N|||F{Constants.vbCr}OBX|30|NM|786-4^MCHC^LN||33.1|g/dL|32.0-36.0|N|||F{Constants.vbCr}OBX|31|NM|788-0^RDW-CV^LN||16.6|%|11.0-16.0|H~N|||F{Constants.vbCr}OBX|32|NM|21000-5^RDW-SD^LN||51.5|fL|35.0-56.0|N|||F{Constants.vbCr}OBX|33|NM|777-3^PLT^LN||26|10*3/uL|100-300|L~A|||F{Constants.vbCr}OBX|34|NM|32623-1^MPV^LN||15.3|fL|6.5-12.0|H~A|||F{Constants.vbCr}OBX|35|NM|32207-3^PDW^LN||16.5||15.0-17.0|A|||F{Constants.vbCr}OBX|36|NM|10002^PCT^99MRC||0.041|%|0.108-0.282|L~A|||F{Constants.vbCr}OBX|37|NM|10013^PLCC^99MRC||18|10*9/L|30-90|L~A|||F{Constants.vbCr}OBX|38|NM|10014^PLCR^99MRC||67.1|%|11.0-45.0|H~A|||F{Constants.vbCr}OBX|39|NM|30392-5^NRBC#^LN||0.000|10*3/uL|0.000-9999.999|N|||F{Constants.vbCr}OBX|40|NM|26461-4^NRBC%^LN||0.00|/100WBC|0.00-9999.99|N|||F{Constants.vbCr}OBX|41|NM|10022^PLT-I^99MRC||26|10*9/L||A|||F{Constants.vbCr}OBX|42|NM|10024^WBC-D^99MRC||7.67|10*9/L||N|||F{Constants.vbCr}OBX|43|NM|10052^TNC-D^99MRC||7.67|10*9/L||N|||F{Constants.vbCr}OBX|44|NM|10026^WBC-N^99MRC||7.79|10*9/L||N|||F{Constants.vbCr}OBX|45|NM|10059^TNC-N^99MRC||7.79|10*9/L||N|||F{Constants.vbCr}OBX|46|NM|10020^HFC#^99MRC||0.02|10*9/L||N|||F{Constants.vbCr}OBX|47|NM|10021^HFC%^99MRC||0.2|%||N|||F{Constants.vbCr}OBX|48|NM|10054^IME%^99MRC||0.0|%||N|||F{Constants.vbCr}OBX|49|NM|10053^IME#^99MRC||0.00|10*9/L||N|||F{Constants.vbCr}OBX|50|NM|10055^H-NR%^99MRC||****|%||N|||F{Constants.vbCr}OBX|51|NM|10056^L-NR%^99MRC||****|%||N|||F{Constants.vbCr}OBX|52|NM|10057^NLR^99MRC||5.01|||N|||F{Constants.vbCr}OBX|53|NM|10058^PLR^99MRC||23.98|||N|||F{Constants.vbCr}OBX|54|NM|10032^InR#^99MRC||0.00|10*9/L||N|||F{Constants.vbCr}OBX|55|NM|10033^InR‰^99MRC||0.00|‰||N|||F{Constants.vbCr}OBX|56|NM|15199-3^Micro#^LN||0.15|10*12/L||N|||F{Constants.vbCr}OBX|57|NM|10042^Micro%^99MRC||5.2|%||N|||F{Constants.vbCr}OBX|58|NM|15198-5^Macro#^LN||0.12|10*12/L||N|||F{Constants.vbCr}OBX|59|NM|10040^Macro%^99MRC||4.1|%||N|||F{Constants.vbCr}OBX|60|NM|10031^PDW-SD^99MRC||25.9|fL||A|||F{Constants.vbCr}OBX|61|NM|12227-5^CORRECTED WBC^LN||7.79|10*3/uL|4.00-10.00|N|||F{Constants.vbCr}OBX|62|IS|12014^Anemia^99MRC||T||||||F{Constants.vbCr}OBX|63|IS|12018^Thrombopenia^99MRC||T||||||F{Constants.vbCr}OBX|64|IS|12068^PLT Abnormal histogram^99MRC||T||||||F{Constants.vbCr}{Strings.ChrW(0x1C)}{Constants.vbCr}";
