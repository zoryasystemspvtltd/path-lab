...
namespace api_test.Controllers
{
    public class LabModelControllerTests
    {
        ...
        private readonly ILogger<PathLabDataService> logger;
        public LabModelControllerTests()
        {
            logger = Substitute.For<ILogger<PathLabDataService>>();
            ...
            var dataLogger = Substitute.For<ILogger<PathLabDataHandler>>();
            var labDataHandler = new PathLabDataHandler(dbContext, dataLogger);
            labDataHandler.Identity = identity;
            var subDynamicDataHandler = new PathLabDataService(labDataHandler, logger);
